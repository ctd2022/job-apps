...
Generate the complete CV now:"""
    ...
    def incorporate_keywords(
        ...
        system_message = (
            ...
            "- EVERY keyword in the list MUST appear somewhere in the output CV\n"
            "- First try to insert each keyword naturally into the most relevant "
            "experience bullet or section\n"
            "- If no natural experience context exists, add the keyword to the "
            "Core Skills section (or create a Skills section if none exists) — "
            "skills sections are always valid placement for domain keywords\n"
            "- Do NOT fabricate experience, achievements, dates, or qualifications\n"
            ...
            "- Do NOT add bold (**text**), italic (*text*), or any other markdown "
            "formatting to injected keywords — match the plain-text style of the existing CV\n\n"
            ...
            "   - Added \"Trade lifecycle\" to Core Skills section\n"
