...
function ApplicationHistory() {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Filters */}
      <div className="bg-white border border-slate-200 px-3 py-2 flex items-center space-x-3">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-sm border border-slate-300 focus:outline-none focus:border-slate-500"
          />
        </div>
        ...
        <select
          ...
          className="px-2 py-1.5 text-sm border border-slate-300 bg-white focus:outline-none focus:border-slate-500"
        >
        ...
        <div className="flex border border-slate-300">
          <button
            ...
            className={`px-2 py-1 text-xs ${sortBy === 'date' ? 'bg-slate-700 text-white' : 'bg-white text-slate-600 hover:bg-slate-50'}`}
          >
          ...
          <button
            ...
            className={`px-2 py-1 text-xs border-l border-slate-300 ${sortBy === 'score' ? 'bg-slate-700 text-white' : 'bg-white text-slate-600 hover:bg-slate-50'}`}
          >
          ...
          <td colSpan={8} className="px-3 py-2">
            ...
            <div className="flex flex-wrap gap-1">
              {(application.files || []).map(file => (
                <span key={file} className="inline-flex items-center space-x-1 px-2 py-0.5 bg-white border border-slate-200 text-xs text-slate-600">
              ...
              <div className="mt-3 pt-3 border-t border-slate-200">
                <div className="flex items-center space-x-2">
                  ...
                  <select
                    ...
                    className="text-xs border border-slate-300 px-2 py-1 bg-white focus:outline-none focus:border-slate-500"
                  >
                    {ALL_STATUSES.map(s => (
                      <option key={s} value={s}>{STATUS_CONFIG[s].label}</option>
                    ))}
                  ...
                  <input
                    ...
                    onClick={(e) => e.stopPropagation()}
                    className="flex-1 text-xs border border-slate-300 px-2 py-1 focus:outline-none focus:border-slate-500"
                  />
                  <button
                ...
                {application.notes && (
                  <div className="mt-2 text-xs text-slate-600 bg-white border border-slate-200 p-2">
